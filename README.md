...
Do ustalenia: albo obsługa przez raise_application_error, albo jasno opisane zachowanie w pakiecie. Warto dopisać walidację w refaktorze.

Testy dla GEN_KSEF_CHECKSUM
...
Zalecenie: dopisać walidację i jawnie rzucać błąd w refaktorze.
...
E. Instrukcja dla użytkowników (dev, QA, analitycy)

Po co jest ten pakiet
